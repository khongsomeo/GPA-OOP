...
test_seeds[17]="./main --input data/has_fail.csv --ignore-input-error"
test_seeds[18]="./main --input data/has_fail.csv --1234 --ignore-input-error"
test_seeds[19]="./main --input data/has_fail.csv --specific data/specific.txt --ignore-input-error"
test_seeds[20]="./main --input data/has_fail.csv --ignore data/ignore.txt --ignore-input-error"
test_seeds[21]="./main --input data/has_fail.csv --csv --ignore-input-error"
test_seeds[22]="./main --input data/has_fail.csv --1234 --csv --ignore-input-error"
test_seeds[23]="./main --input data/has_fail.csv --specific data/specific.txt --csv --ignore-input-error"
test_seeds[24]="./main --input data/has_fail.csv --ignore data/ignore.txt --csv --ignore-input-error"
test_seeds[25]="./main --input --csv --ignore-input-error"
